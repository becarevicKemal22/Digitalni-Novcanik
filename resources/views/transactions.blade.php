<x-app-layout>
    ...
    <div class="w-1/3 mx-auto">
        @foreach($transactions as $transaction)
            <div class="mb-4 rounded-full px-10 py-4 flex-col min-w-full items-center bg-siva shadow-lg hover:bg-accent hover:normal">
                ...
                <div class="category mt-2 px-5 py-1.5 rounded-full max-w-fit" style="background-color: {{$transaction->category->boja}}">
